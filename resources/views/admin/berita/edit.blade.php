    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <p class="mb-0" style="color: #38527E"><a href="{{ route('dashboard') }}" class="text-decoration-none">Pusat Halal
                    Insan Kamil</a> /
                <a href="{{ route('kelola-berita.index') }}" class="text-decoration-none">Daftar Berita</a> / Edit
            </p>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card p-3">
                    <form id="new-berita" action="{{ route('kelola-berita.update', $berita->id) }}" method="post"
                        ...
                        <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10" required>{{ $berita->deskripsi }}</textarea>
...
@section('scripts')
    ...
    <script>
        let form = document.getElementById('new-berita')
