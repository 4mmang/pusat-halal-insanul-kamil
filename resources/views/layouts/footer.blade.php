<section id="bg-footer" class="py-5" style="background-color: #333;">
    <div class="container text-wrapper-1 text-start">
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-center justify-content-md-end justify-content-start mt-3 mt-md-0">
                <a href="https://wa.me/6285240364660" class="btn btn-warning rounded-5 px-4 py-2 text-default">
                    Hubungi Kami
                </a>
            </div>
        </div>
...
<section class="py-5 bg-primary">
    <div class="container">
        <div class="row text-white">
            <p class="fs-3 playfair">LPH <span class="text-warning">Pusat Halal Insan Kamil</span></p>
            <div class="col-md-6 text-white">
                <p><span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-telephone-x text-warning" viewBox="0 0 16 16">
                            <path
                        ...
                        </svg></span> 0852-4036-4660</p>
                <p><span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-envelope text-warning" viewBox="0 0 16 16">
                            <path
                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                        </svg></span> pusathalalinsankamilsulsel@gmail.com</p>
                <p><span class="me-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            fill="currentColor" class="bi bi-geo-alt text-warning" viewBox="0 0 16 16">
                            <path
                                d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10" />
                            <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6" />
                        </svg></span>Sekretariat: BTN Arawa Permai Blok B/54, Batulappa, Sidenreng Rappang</p>
            </div>
            <div class="col-md-6 text-white">
