...
@section('content')
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4 align-items-stretch">
                <div class="col">
                    <div class="card h-100 shadow-lg p-1">
                        <div class="card-body">
                            <p class="text-center text-default"><svg xmlns="http://www.w3.org/2000/svg" width="60"
                                    height="60" fill="currentColor" class="bi bi-check2-circle" viewBox="0 0 16 16">
                                    <path
                            ...
                            <p class="text-center">
                                ...
                                bisnis
                                Anda memenuhi standar halal sesuai peraturan yang berlaku di Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card shadow-lg h-100 p-1">
                        <div class="card-body">
                            ...
                            <p class="text-center">
                                Dengan tim ahli yang berpengalaman, kami memastikan setiap proses sertifikasi dilakukan
                                dengan transparansi dan efisiensi tinggi.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-5 bg-body-secondary">
        <div class="container pb-4">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="fs-3 playfair text-center mb-5 text-default">Regulasi Sertifikasi Halal</p>
                    <p>Pemerintah indonesia telah mewajibkan produk yang masuk, beredar dan diperdagangkan di Indonesia
                        bersertifikat halal melalui Undang-Undang Jaminan Produk Halal No. 33 Tahun 2014. Produk yang
                        dimaksud adalah barang dan/atau jasa yang terkait dengan makanan, minuman, obat, kosmetik, produk
                        kimiawi, produk biologi, produk rekayasa genetik, serta barang gunaan.</p>
